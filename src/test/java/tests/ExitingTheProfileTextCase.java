...
public class ExitingTheProfileTextCase  {
    ...
    public void checkSubmit() {
        ...
        element4.click();
        WebElement element5 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='Profile_title__2T3Cy']")));
        element5.click();
