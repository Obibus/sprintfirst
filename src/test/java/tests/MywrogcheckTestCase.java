...
public class MywrogcheckTestCase {
    @Test
    public void checkSubmit() {
        ...
        WebElement element5 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='/tests/my-mistakes']")));
        element5.click();
        WebElement element6 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='page-title']//p")));
