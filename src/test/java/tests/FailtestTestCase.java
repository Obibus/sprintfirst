...
public class FailtestTestCase {
    ...
    public void checkSubmit() {
        ...
        WebElement element_test = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@class='Tests_itemInner__jkDuo  ']")));
        element_test.click();

        WebElement element_button = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='Exam_buttonWrap__aCRIM']//button")));
        element_button.click();
        WebElement element_button2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='Exam_buttonWrap__aCRIM']//button[text()='У разі виконання випередження колони.']")));
