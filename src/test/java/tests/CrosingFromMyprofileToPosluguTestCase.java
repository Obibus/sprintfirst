...
public class CrosingFromMyprofileToPosluguTestCase {
    @Test
    public void checkSubmit() {
        ...
        WebElement element6 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[text()='Послуги']")));
        element6.click();
